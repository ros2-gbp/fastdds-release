...
## fastdds (rolling) - 3.6.2-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling fastdds` on `Thu, 02 Jul 2026 13:15:16 -0000`
...
## fastdds (rolling) - 3.6.1-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling fastdds` on `Tue, 21 Apr 2026 14:50:58 -0000`
...
## fastdds (kilted) - 3.2.4-1

The packages in the `fastdds` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted fastdds` on `Thu, 09 Apr 2026 12:50:14 -0000`
...
## fastdds (rolling) - 3.6.0-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/local/bin/bloom-release -r rolling -e fastdds` on `Fri, 03 Apr 2026 10:25:32 -0000`
...
## fastrtps (jazzy) - 2.14.6-1

The packages in the `fastrtps` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy fastrtps` on `Tue, 03 Mar 2026 11:37:39 -0000`
...
- upstream repository: https://github.com/eProsima/Fast-DDS.git
- release repository: https://github.com/ros2-gbp/fastdds-release.git
- rosdistro version: `2.14.5-2`
- old version: `2.14.5-2`
...
## fastdds (rolling) - 3.4.2-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling fastdds` on `Fri, 30 Jan 2026 08:33:42 -0000`
...
## fastrtps (humble) - 2.6.11-1

The packages in the `fastrtps` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble fastrtps` on `Mon, 22 Dec 2025 14:55:44 -0000`
...
## fastdds (rolling) - 3.4.1-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -e -r rolling fastdds` on `Tue, 16 Dec 2025 10:00:21 -0000`
...
## fastdds (kilted) - 3.2.3-1

The packages in the `fastdds` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted fastdds` on `Mon, 03 Nov 2025 08:41:51 -0000`
...
## fastdds (rolling) - 3.2.3-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling fastdds` on `Mon, 03 Nov 2025 08:35:57 -0000`
...
## fastrtps (jazzy) - 2.14.5-2

The packages in the `fastrtps` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy fastrtps` on `Fri, 01 Aug 2025 12:15:54 -0000`
...
## fastrtps (jazzy) - 2.14.5-1

The packages in the `fastrtps` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy fastrtps` on `Thu, 31 Jul 2025 08:45:02 -0000`
...
## fastdds (rolling) - 3.2.2-1

The packages in the `fastdds` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release fastdds -r rolling` on `Thu, 08 May 2025 14:35:29 -0000`
...
## fastdds (kilted) - 3.2.2-1

The packages in the `fastdds` repository were released into the `kilted` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release fastdds -r kilted` on `Thu, 08 May 2025 14:31:07 -0000`
...
## fastrtps (humble) - 2.6.10-1

The packages in the `fastrtps` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble fastrtps` on `Thu, 24 Apr 2025 07:38:37 -0000`
...
The packages in the `fastdds` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling fastdds` on `Mon, 03 Mar 2025 18:45:16 -0000`
